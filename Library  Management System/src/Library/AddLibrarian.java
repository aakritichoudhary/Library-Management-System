...
public class AddLibrarian extends JFrame implements ActionListener {
    ...
    AddLibrarian() {
        ...
        p2 = new JPanel();
        p2.setLayout(new GridLayout(7, 2, 0, 0));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == bt1) {
            try {
                ...
                if (aa == 1) {
                    JOptionPane.showMessageDialog(null, "Data successfully inserterd");
                    this.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "Kindly fill correct details");
