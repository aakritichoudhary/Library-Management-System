...
public class LibrarianSection extends JFrame implements ActionListener {
    ...
    LibrarianSection() {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Library/icon/booksimage.jpg"));
        ...
        JMenuItem ment3 = new JMenuItem("View Issued Book");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (comd.equals("View Issued Book")) {
